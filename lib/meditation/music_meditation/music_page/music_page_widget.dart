...
class _MusicPageWidgetState extends State<MusicPageWidget> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<MusicRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<MusicRecord> musicPageMusicRecordList = snapshot.data!;
                    ...
                    Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Builder(
                            builder: (context) {
                              final music = musicPageMusicRecordList.toList();
                              return ListView.separated(
                                ...
                                itemBuilder: (context, musicIndex) {
                                  final musicItem = music[musicIndex];
                                  return InkWell(
                                    ...
                                    onTap: () async {
                                      context.pushNamed(
                                        'PlayMusic',
                                        queryParameters: {
                                          'musicTittle': serializeParam(
                                            musicItem.musicname,
                                            ParamType.String,
                                          ),
                                          'musicDescription': serializeParam(
                                            musicItem.musicDescription,
                                            ParamType.String,
                                          ),
