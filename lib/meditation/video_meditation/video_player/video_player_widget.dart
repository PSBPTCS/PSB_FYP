                ...
                Expanded(
                  child: Stack(
                    children: [
                      ...
                      Align(
                        alignment: const AlignmentDirectional(-0.96, 1.0),
                        child: FlutterFlowTimer(
                          initialTime: widget.vidDuration!,
                          ...
                          onEnded: () async {
                            await MeditiationProgressRecord.collection
                                .doc()
                                .set({
                              ...createMeditiationProgressRecordData(
                                meditatioProgressUser: currentUserReference,
                                meditationDuration: widget.vidDuration,
